...
public class Eat  extends MainActivity {
    ...
    String[] QUESTIONS = {
            "1. 'Fish' - це ",
            "1. Перекладіть слово 'coffee'",
            "3. Виберіть правильний переклад слова 'Wine'",
            "4. Перекладіть слово 'an egg'",
            "5. Виберіть правильний переклад слова 'a plate'",
            "6. Перекладіть фразу 'I drink juice'",
            "7. 'a chicken' - це ?",
            "8. Перекладіть слово 'an orange'",
            "9. Перекладіть слово 'breakfast'",
            "10. 'tea' - це ",
    };
    ...
    String[] userANSWERS = {};
    String[] ANSWERS = {
            "пиво", "м'ясо", "риба", "хліб",
            "кава", "чай", "риба", "морозиво",
            "сік", "вино", "пиво", "чай",
            "м'ясо", "суп", "яблуко", "яйце",
            "ніж", "ложка", "тарілка", "хліб",
            "я п'ю сік", "я їм рибу", "я п'ю пиво", "я їм м'ясо",
            "тарілка", "м'ясо", "риба", "курка",
            "яйце", "хліб", "мандарин", "апельсин",
            "сніданок", "обід", "вечеря", "сік",
            "сік", "кава", "чай", "суп",
    };
        ...
        btnSubmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (radioGroup.getCheckedRadioButtonId() == - 1) {
                    ...
                    Toast.makeText(Eat.this, "Виберіть відповідь", Toast.LENGTH_SHORT).show();
                }
                else {
                    ...
                    if (question_counter < QUESTIONS.length) {
                        ...
                        Intent ResultActivity = new Intent(Eat.this, app.sashakhyzhun.wordsteacher.ResultActivity.class);
